...
import { resetAdminPassword } from "../../services/AuthService"; // NEW
                    ...
                    <tr key={a.id} className="text-sm text-gray-700 border-b hover:bg-green-50/50 transition-colors">
                      ...
                      <td className="py-3 px-4 text-center">
                        <div className="flex items-center justify-center space-x-2">
                          ...
                          {/* NEW: Reset Password */}
                          <button onClick={() => handleResetPasswordClick(a)} className="text-amber-500 hover:text-amber-700 p-1 rounded hover:bg-amber-50 transition-colors" title="Reset Kata Sandi">
                            <KeyRound size={18} />
                          </button>
