...
const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (newPassword.length < MIN_LEN) {
      toast.error(`Kata sandi baru minimal ${MIN_LEN} karakter.`);
      return;
    }
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              ...
              <button onClick={handleClose} disabled={isSubmitting} className="text-gray-400 hover:text-gray-600 transition-colors p-1 rounded-lg hover:bg-gray-100">
                <X size={18} />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-1">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting || !match || newPassword.length < MIN_LEN || currentPassword.length === 0}
