...
import { FaChevronRight, FaMapMarkerAlt, FaEnvelope, FaPhoneAlt, FaTiktok, FaInstagram, FaYoutube } from "react-icons/fa";
          ...
          <motion.div variants={linkVariants}>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-3">
                ...
                <a href="https://www.youtube.com/c/LazisnuKudus" className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-600/50 hover:bg-primary transition-colors" target="_blank">
                  <FaYoutube className="w-4 h-4" />
                </a>
                {/* TikTok */}
                <a href="https://www.tiktok.com/@lazisnukudus" target="_blank" className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-600/50 hover:bg-primary transition-colors">
                  <FaTiktok className="w-4 h-4" />
                </a>
                {/* Instagram */}
                <a href="https://www.instagram.com/nucarelazisnukudus/" target="_blank" className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-600/50 hover:bg-primary transition-colors">
